...
import org.exoplatform.answer.webui.popup.UIMoveCategoryForm;
import org.exoplatform.answer.webui.popup.UIQuestionForm;
import org.exoplatform.answer.webui.popup.UIWatchManager;
...
@ComponentConfig(
    ...
    template = "app:/templates/answer/webui/UICategories.gtmpl", 
    events = { 
